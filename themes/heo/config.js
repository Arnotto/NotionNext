const CONFIG = {
  ...
  HEO_SITE_CREATE_TIME: '2026-02-1', // 建站日期，用于计算网站运行的第几天

  // 首页顶部通知条滚动内容，如不需要可以留空 []
  HEO_NOTICE_BAR: [
    { title: '欢迎来到我的博客', url: 'https://www.xiaogouanuo.blog' },
    { title: '汪！', url: 'https://www.xiaogouanuo.blog' }
  ],
  ...
  // 英雄区(首页顶部大卡)
  HEO_HERO_TITLE_1: '快乐狗狗',
  HEO_HERO_TITLE_2: '快乐生活',
  HEO_HERO_TITLE_3: 'xiaogouanuo.blog',
  HEO_HERO_TITLE_4: '欢迎来到我的基地',
  HEO_HERO_TITLE_5: '一个小狗狗的生活记录',
  HEO_HERO_TITLE_LINK: 'https://www.xiaogouanuo.blog',
  // 英雄区遮罩文字
  HEO_HERO_COVER_TITLE: '随便逛逛',

  // 英雄区显示三个置顶分类
  HEO_HERO_CATEGORY_1: { title: '好朋狗', url: '/tag/好朋狗' },
  HEO_HERO_CATEGORY_2: { title: '线下活动', url: '/tag/线下活动' },
  HEO_HERO_CATEGORY_3: { title: '珍藏照片', url: '/tag/珍藏照片' },

  // 英雄区右侧推荐文章标签, 例如 [推荐] , 最多六篇文章; 若留空白''，则推荐最近更新文章
  HEO_HERO_RECOMMEND_POST_TAG: '推荐',
  HEO_HERO_RECOMMEND_POST_SORT_BY_UPDATE_TIME: true, // 推荐文章排序，为`true`时将强制按最后修改时间倒序
  //   HERO_RECOMMEND_COVER: 'https://raw.githubusercontent.com/Arnotto/picture/refs/heads/essay/IMG_20260517_172355.jpg', // 英雄区右侧图片
  ...
  HEO_INFO_CARD_URL2: 'https://www.xiaogouanuo.blog',
  HEO_INFO_CARD_ICON2: 'fab fa-github',
  HEO_INFO_CARD_URL3: 'https://www.xiaogouanuo.blog',
